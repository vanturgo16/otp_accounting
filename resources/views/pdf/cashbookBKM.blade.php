...
<html lang="en">
<head>
    <title>Bukti Kas Masuk - {{ $detail->transaction_number }}</title>
    <!-- Bootstrap CSS -->
...
<body class="padded-element-main">
            ...
            <tr>
                ...
                <td 
                    style="
                        ...
                        ">
                    <span style="font-size: 20px; font-weight: bold">BUKTI KAS MASUK</span>
                </td>
            </tr>
            <tr>
                <td 
    ...
    <main>
            ...
            <tbody>
                <tr>
                    <td class="align-middle text-right" 
                        ...
                        BKM NO. <strong style="text-decoration: underline">{{ $detail->transaction_number ?? '________' }}</strong>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <br>
        <br>
        <h3 class="text-center">FILE CONTOH PRINT BKM BELUM DIKIRIM</h3>
    </main>
</body>
</html>