                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 mb-3">
                                    ...
                                    <i class="mdi mdi-information-outline"
                                        ...
                                        title="Pilih tanggal invoice. Tanggal invoice hanya dapat dipilih mulai 20 hari sebelum akhir bulan sebelumnya hingga tanggal hari ini.">
                                    </i>
                                ...
                                <div class="col-lg-3 mb-3">
                                    ...
                                    <input type="date" class="form-control" name="due_date" value="{{ \Carbon\Carbon::parse($detail->due_date)->format('Y-m-d') }}" required min="{{ $minDate }}">
                                </div>
                                <div class="col-lg-6 mb-3">
