                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="text-end d-block d-lg-none">
                                    <i class="mdi mdi-information-outline text-muted" data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="Edit and Delete actions are only available for Super Admin. Transactions can only be edited or deleted from 20 days before the end of the previous month up to today. The DN Number cannot be changed; to update it, please delete the transaction and create a new one.">
                                    </i>
                                </div>
                            </div>
                        </div>
