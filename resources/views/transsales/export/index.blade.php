        ...
        <div class="modal fade" id="sort" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form class="formLoad" action="{{ route('transsales.export.index') }}" method="GET" enctype="multipart/form-data">
                        @csrf
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header p-3">
                        <div class="row">
                            <div class="col-lg-4">
                                <a href="{{ route('transsales.export.create') }}" type="button" class="btn btn-primary waves-effect btn-label waves-light">
