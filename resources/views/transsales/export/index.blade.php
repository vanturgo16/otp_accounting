            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <div class="page-title-left">
                        <a href="{{ route('transsales.export.create') }}" type="button" class="btn btn-primary waves-effect btn-label waves-light"><i class="mdi mdi-plus-box label-icon"></i> Add New Sales Transaction (Export)</a>
                    </div>
        ...
        <div class="modal fade" id="sort" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('transsales.export.index') }}" id="formfilter" method="POST" enctype="multipart/form-data">
                        @csrf
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header text-center py-3">
                        <h5 class="mb-0"><b>Sales Transaction (Export)</b></h5>
                        List of 
                        @if($ref_number != null)
...
<script>
    $(function() {
        var i = 1;
        var url = '{!! route('transsales.export.index') !!}';
