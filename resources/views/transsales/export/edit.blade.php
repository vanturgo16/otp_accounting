                                ...
                                <div class="card-body" style="background-color:ghostwhite">
                                    <div class="row">
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input class="form-control" id="po_number" type="text" value="{{ $detail->customer_name }}" placeholder="Select Delivery Notes.." style="background-color:#EAECF4" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-3">
                                            ...
                                            <input class="form-control" id="customer_address" type="text" value="{{ $detailCust->address ?? '-' }}" placeholder="Select Delivery Notes.." style="background-color:#EAECF4" readonly>
                                        </div>
                                        <div class="col-lg-6 mb-3">
