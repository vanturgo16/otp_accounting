                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel">Add New Sales Invoice</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <form action="{{ route('salesinvoice.store') }}" id="formadd" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-body py-8 px-4" style="max-height: 67vh; overflow-y: auto;">
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-2">
                                                    <label class="form-label">DN Number</label><label style="color: darkred">*</label>
                                                    <select class="form-select" id="id_delivery_notes" name="id_delivery_notes" required>
                                                        <option value="" selected>--Select DN Number--</option>
                                                        @foreach($dnnumbers as $item)
                                                            <option value="{{ $item->id }}">{{ $item->dn_number }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-6 mb-2">
                                                    <label class="form-label">Print with DN ?</label><label style="color: darkred">*</label>
                                                    <div class="form-check form-switch form-switch-md mb-3" dir="ltr">
                                                        <input type="checkbox" name="print_with_dn" class="form-check-input" id="customSwitchsizemd">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-6 mb-2">
                                                    <label class="form-label">Customer</label><label style="color: darkred">*</label>
                                                    <select class="form-select" id="id_master_customers" name="id_master_customers" required>
                                                ...
                                                <div class="col-6 mb-2">
                                                    <label class="form-label">Customer Address</label><label style="color: darkred">*</label>
                                                    <select class="form-select" id="id_delivery_notes" name="id_delivery_notes" required>
                                                ...
                                                <div class="col-6 mb-2">
                                                    ...
                                                    <select class="form-select" id="id_master_term_payments" name="id_master_term_payments" required>
                                                        <option value="" selected>--Select Term Payment--</option>
                                                        @foreach($terms as $item)
                                                            <option value="{{ $item->id }}">{{ $item->term_payment }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-6 mb-2">
                                                ...
                                                <div class="col-6 mb-2">
                                                    ...
                                                    <input class="form-control" name="due_date" type="date" value="" required>
                                                </div>
                                                <div class="col-6 mb-2">
