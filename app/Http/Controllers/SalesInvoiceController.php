...
class SalesInvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('SalesInvoice.index',compact('datas', 'currencies', 'accountcodes', 'typetrans', 'listbank', 'dnnumbers',
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            SalesInvoice::where('id', $data->id)->update([
    ...
    public function update(Request $request, $id)
    {
        ...
        $databefore = SalesInvoice::where('id', $id)->first();
        ...
        if($databefore->isDirty()){
            DB::beginTransaction();
            try{
                $data = SalesInvoice::where('id', $id)->update([
                    'bank' => $request->bank,
                    'currency' => $request->currency,
                    'date' => $request->date,
                    'id_master_account_codes' => $request->id_master_account_codes,
                ...
                $trans_number = SalesInvoice::where('id', $id)->first()->trans_number;
